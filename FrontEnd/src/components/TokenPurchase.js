        ...
        <div className="mb-8">
          ...
          <div className="mb-8">
            ...
            {selectedNetwork && selectedToken ? (
              <div className="bg-gradient-to-r from-purple-200 to-blue-200 p-6 rounded-xl flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row items-center md:justify-between gap-4 bg-gradient-to-r from-purple-200 to-blue-200 p-4 rounded-xl">
              {/* First Input Group */}
              ...
              <div className="flex items-center gap-2 bg-[#FFFFFF] p-4 rounded-lg w-full md:w-96">
                ...
                />
                <div className="flex items-center gap-2 min-w-fit">
                  <div className="bg-gradient-to-r from-purple-100 to-purple-300 rounded-full p-1 w-6 h-6">
                    <img
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="text-xl font-bold">
              Allocated: $SBX{" "}
              {Number(presaleTransactionsSum.toFixed(6))?.toLocaleString(
                "en-US"
              )}
            </span>
          </div>
              ...
              <tbody>
                {presaleTransactions.map((wallet) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 break-all">
                      {parseFloat(wallet.sbx_price).toFixed(2)}
                    </td>
                    <td className="px-4 py-2 break-all">
                      {parseFloat(wallet.usdt_amount).toFixed(2)}
                    </td>
                    <td className="px-4 py-2 break-all">
